...
export const TEMPLATES = [
  ...
  },
  {
    ...
    target_rpe: [8, 9],
    stimulus: '20 secondi massimali, 10 di riposo, 8 round per movimento',
  },
  {
    id: 'death_by',
    label: 'Death By',
    ...
    target_rpe: [7, 9],
    stimulus: '1 rep al minuto 1, +1 rep ogni minuto, finché regge il ritmo',
  },
  {
    id: 'strength_press',
    label: 'Forza (press pesante)',
    goals: ['strength'],
    format: 'Strength',
    time_domain: [15, 25],
    duration: 20,
    movement_slots: [
      { pattern: 'press', modality: 'weightlifting' },
    ],
    target_rpe: [6, 8],
    stimulus: 'basse ripetizioni, recupero quasi completo, tecnica prioritaria',
  },
  ...
  {
    id: 'advanced_gymnastics_skill',
    label: 'Skill ginnastico avanzato',
    goals: ['gymnastics'],
    format: 'E2MOM',
    time_domain: [12, 24],
    duration: 18,
    ...
    target_rpe: [5, 7],
    stimulus: 'lavoro su skill di alto livello (muscle-up, handstand walk, rope climb), qualità sopra la quantità',
  },
  {
